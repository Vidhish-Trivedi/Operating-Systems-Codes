...
int main(){
    ...
    write(1, "Now unlocking\n", sizeof("Now unlocking\n"));
...
// Note: Program takes user input as the room number, and reads the tickets, while not locking the other records in the file.
